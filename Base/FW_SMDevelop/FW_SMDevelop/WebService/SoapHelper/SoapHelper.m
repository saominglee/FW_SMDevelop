...
+(NSString*)methodSoapMessage:(NSString*)methodName webServiceNameSpcae:(NSString*) nameSpace{
...
+(NSString*)arrayToDefaultSoapMessage:(NSArray*)arr methodName:(NSString*)methodName webServiceNameSpcae:(NSString*) nameSpace{
    if ([arr count]==0||arr==nil) {
        return [NSString stringWithFormat:[self methodSoapMessage:methodName webServiceNameSpcae:nameSpace],@""];
    }
    ...
    return [NSString stringWithFormat:[self methodSoapMessage:methodName webServiceNameSpcae:nameSpace],msg];
}
