...
+ (ASIHTTPRequest*)commonSharedRequestMethod:(NSString*)methodName SoapMessage:(NSString*)soapMsg webServiceUrl:(NSString*)url webServiceNameSpace:(NSString*)nameSpace
{
    return [self commonSharedServiceRequestUrl:url ServiceNameSpace:nameSpace ServiceMethodName:methodName SoapMessage:soapMsg];
}
#pragma mark -
#pragma mark 同步请求
...
- (NSString*)syncServiceMethod:(NSString*)methodName SoapMessage:(NSString*)soapMsg webServiceUrl:(NSString*)url webServiceNameSpace:(NSString*)nameSpace
{
    return [self syncServiceRequestUrl:url ServiceNameSpace:nameSpace ServiceMethodName:methodName SoapMessage:soapMsg];
}
#pragma mark -
#pragma mark 异步请求
...
- (void)asynServiceMethod:(NSString*)methodName SoapMessage:(NSString*)soapMsg webServiceUrl:(NSString*)url webServiceNameSpace:(NSString*)nameSpace
{
    [self asynServiceRequestUrl:url ServiceNameSpace:nameSpace ServiceMethodName:methodName SoapMessage:soapMsg];
}
#pragma mark -
...
- (NSString*)soapMessageResult:(ASIHTTPRequest*)request
{
    ...
    //[SoapXmlParseHelper parseTest:data ServiceMethodName:methodName];
    NSString* responseString = [request responseString];
    responseString = [responseString stringByReplacingOccurrencesOfString:@"(" withString:@""];
    responseString = [responseString stringByReplacingOccurrencesOfString:@")" withString:@""];
//    NSArray* arr = (NSArray*)[responseString mutableObjectFromJSONString];
//    for (NSDictionary* dic in arr) {
//        NSString* name = [dic objectForKey:@"TagName"];
//        NSString* ID = [dic objectForKey:@"TagID"];
//        NSString* Counter = [dic objectForKey:@"TagCounter"];
//        NSLog(@"TagName is:%@", name);
//        NSLog(@"TagID is:%@", ID);
//        NSLog(@"UTagCounter:%@", Counter);
//        NSLog(@"-------------------");
//    }
