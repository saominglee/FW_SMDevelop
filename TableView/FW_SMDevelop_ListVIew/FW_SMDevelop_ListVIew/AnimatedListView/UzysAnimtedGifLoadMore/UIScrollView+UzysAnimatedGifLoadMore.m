...
-(void)addLoadMoreActionHandler:(loadMoreActionHandler)handler
                ...
                ProgressTipText:(NSString *)progresstext
                LoadingTipText:(NSString *)loadingtext
                TipTextWidth:(int)width
{
    if(self.loadMoreView == nil)
    {
        ...
        [view setLoadMoreProgressTipText:progresstext];
        [view setLoadMoreLoadingTipText:loadingtext];
        [view setTipTextWidth:width];
    }
}
...
- (void)addLoadMoreActionHandler:(loadMoreActionHandler)handler
         ...
         ProgressScrollThreshold:(NSInteger)threshold
          LoadingImagesFrameRate:(NSInteger)lframe
{
    [self addLoadMoreActionHandler:handler ProgressImages:progressImages LoadingImages:loadingImages ProgressScrollThreshold:threshold LoadingImagesFrameRate:lframe ProgressTipText:@"松开查看更多" LoadingTipText:@"正在加载中阿..." TipTextWidth:120];
}
           ...
           LoadingImageFrameRate:(NSInteger)frameRate
{
    ...
    [self addLoadMoreActionHandler:handler ProgressImagesGifName:progressGifName LoadingImagesGifName:loadingGifName ProgressScrollThreshold:threshold LoadingImageFrameRate:frameRate ProgressTipText:@"松开查看更多" LoadingTipText:@"正在加载中..." TipTextWidth:120];
}
                    ...
                    TipTextWidth:(int)width
{
    ...
    [self addLoadMoreActionHandler:handler
           ...
           ProgressScrollThreshold:threshold
            ...
            ProgressTipText:progresstext LoadingTipText:loadingtext TipTextWidth:width];
}
